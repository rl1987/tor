...
testcases = [
              Testcase(arguments=['-5', '-v', 'mit.edu', '127.0.0.1:'+str(socks_port)],
              ...
              Testcase(arguments=['-5', '-v', '-x', '8.8.8.8',
              ...
              Testcase(arguments = ['-4', '-v', 'mit.edu',
                  '127.0.0.1:'+str(socks_port)],
              ...
              Testcase(arguments = ['-4', '-v', 'torproject.org',
                  '127.0.0.1:'+str(socks_port)],
